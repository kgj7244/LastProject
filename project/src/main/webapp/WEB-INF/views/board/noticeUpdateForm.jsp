			...
			<table class="table table-borderd">
				...
				<tr>
					...
					<td><input type="text" name="n_title" required="required"
						autofocus="autofocus" value=${notice.n_title }></td>
				</tr>
				<tr>
					<td>내용</td>
					<td><textarea rows="5" cols="40" required="required"
							name="n_content">${notice.n_content }</textarea></td>
				</tr>
				<tr>
