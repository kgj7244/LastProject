...
<%@ include file="../mainNav.jsp" %>
	<div class="container" align="center">
		...
		<table class="table table-borderd">
			...
			<tr>
				<td>제목</td>
				<td><input type="text" name="b_title" required="required" autofocus="autofocus" value=${board.b_title }></td>
			</tr>
			<tr>
				<td>내용</td>
				<td><textarea rows="5" cols="40" required="required" name="b_content">${board.b_content }</textarea></td>
			</tr>
			<tr>
				<td>비밀글 선택</td>
