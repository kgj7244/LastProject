...
<tr><td>판매기간</td><td><input type="date" name="s_per"
required="required"></td></tr>
...
<!-- ========= 
<tr><td>총 판매수량</td><td><input type="number" name="s_prive"
required="required"></td></tr>

<tr><td>구매수량</td><td><input type="number" name="s_prive"
required="required"></td></tr>

<tr><td>할인율</td><td><input type="number" name="s_prive"
required="required"></td></tr>
