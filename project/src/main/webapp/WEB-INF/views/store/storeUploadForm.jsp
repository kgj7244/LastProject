...
required="required" value="${store.s_per }"></td></tr>

<tr><td>상품 유효기간</td><td><input type="date" name="s_validity" 
value="sysdate" required="required" value="${store.s_validity }"></td></tr>

<tr><td>총 판매수량</td><td><input type="number" name="s_total" value="9999"
required="required" value="${store.s_total }"></td></tr>
...
required="required" value="${store.s_sale }"></td></tr>
