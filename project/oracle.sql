...
insert into movie values(3, '가즈아','아프라카타브라','12','2011-11-11','상영','120','0','xxx.jsp','김희주','해리','마법','n');
insert into movie values(4, '트랜스포머','아프라카타브라','15','2011-11-11','상영','120','0','xxx.jsp','김희주','해리','마법','n');
insert into movie values(5, '어벤져스','아프라카타브라','19','2011-11-11','상영','120','0','xxx.jsp','김희주','해리','마법','n');
insert into movie values(6, '해리포터','아프라카타브라','12','2011-11-11','상영','120','0','xxx.jsp','김희주','해리','마법','n'); 
